...
export default async function BookingsServerPage() {
  ...
  const { data: bookings, error: bookingsError } = await adminClient
    .from('bookings')
    .select('id, reference, customer_name, customer_email, plate, car_make, car_model, car_color, start_at, end_at, status, money_charged, money_received, flight_number, source, created_at')
